...
@Component({
  selector: 'app-herra-manuales',
  templateUrl: './herra-manuales.page.html',
  styleUrls: ['./herra-manuales.page.scss'],
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
...
export class HerraManualesPage implements OnInit {
  ...
  productos = [
    {
      ...
      imagen: 'assets/img/herramienta.png'
    },
    {
      marca: 'TEL',
